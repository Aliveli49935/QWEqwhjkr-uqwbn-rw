...
client.on("guildMemberAdd", member => {  
    ...
    const register = "<@&800355632536092693>"
 ...
 const hgmesaj = (`Sunucumuza hoşgeldin (<@${vader.id}>) - (\`${vader.id}\`)\n \n Seninle beraber sunucumuz(`  + üyesayısı +  `)kişiye ulaştı. \n\n Hesabın (**`  + moment(member.user.createdAt).format("DD MMMM YYYY dddd") + `**) oluşturulduğu için `  + kontrol + `\n\n Kayıt olmak için welcome-to-atlantis kanalına isim yaş yazman yeterlidir. \n\n Kayıt olduktan sonra #kurallar daki tepkiye tıkla. \n\n   <@&800355632536092693> `)
kanal.send(hgmesaj)
